...
> A simple, privacy‑first digital cookbook – add, view and search your recipes locally.

---

## Overview

Home cooks waste time digging through paper notes, scattered screenshots, or third‑party apps to find a recipe they saved, and they worry about their personal cooking data being sent to the cloud.
...
```yaml
name: recipe-box-lite
services:
  - name: api
    github:
      repo: Two-Weeks-Team/recipe-box-lite
      branch: master
